...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.databaseSelectionData.currentIndexChanged.connect(self.set_collections)
        ...
        self.deleteSelectedButton.clicked.connect(self.delete_record)
    ...
    def set_collections(self):
        if self.collectionSelectionData.count() > 0:
            self.collectionSelectionData.clear()
    ...
    def delete_record(self):
        ...
        for s in selected_indexes:
            mysql_functions.delete(db_name, table_name, data[s.row()])
            self.tableWidget.removeRow(s.row())
        self.load_data()
